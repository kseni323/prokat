<?php
		...
		$to = "geo.mahmoudtaha@gmail.com"; // Your e-mail address here.
		...
		$mail->Username = "geo.mahmoudtaha";  // SMTP username
		$mail->Password = "bnpcjgdrfhirzxuh";  // SMTP password
		$mail->SMTPSecure = "tls";  // Enable TLS encryption, `ssl` also accepted
		$mail->Port = "587";          // TCP port to connect to

		$mail->setFrom("geo.mahmoudtaha");
